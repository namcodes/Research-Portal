...
<head>
  ...
  <title>Research Portal | Users</title>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="users.php" class="nav-link active bg-gradient-primary">
              ...
              <div class="card card-outline card-primary">
                ...
                <div class="card-body table-responsive">
                  <table id="table" class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                      <?php
                      $tbl_users = $conn->query("SELECT * FROM tbl_users WHERE NOT user_id = '".$user_id."' ORDER BY _id ASC");
                      $counter = 0;
                      foreach ($tbl_users as $tbl_row) {
                        ++$counter;
                        echo (' 
                          <tr>
                              ...
                              <td style="white-space: nowrap">
                                <img
                                  src="../wp-images/' . $tbl_row['avatar'] . '"
                                  alt="avatar"
                                  class="img-circle border p-1"
                                  width="40"
                                />
                              </td>
                              <td style="white-space: nowrap">' . $tbl_row['user_id'] . '</td>
                              <td style="white-space: nowrap">' . $tbl_row['first_name'] . ' ' . $tbl_row['last_name'] . '</td>
                              <td style="white-space: nowrap">' . $tbl_row['role'] . '</td>
                              <td style="white-space: nowrap">
                                <button
                                  data-id="' . $tbl_row['user_id'] . '"
  ...
  <div class="modal fade" id="add-user" style="display: none" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="../wp-includes/users.php" enctype="multipart/form-data" method="post">
          ...
          <div class="modal-footer justify-content-between">
            ...
            <button name="create-user" class="btn btn-primary" type="submit">
              Save
            </button>
          </div>
        </form>
  ...
  <div class="modal fade" id="edit-user" style="display: none" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="../wp-includes/users.php" enctype="multipart/form-data" method="post">
          <div class="modal-body">
            <input type="text" class="token_id" name="token_id" hidden>
            <div class="form-group">
              <label for="avatar">Avatar</label>
              <div class="input-group">
                <div class="custom-file">
            ...
            <div class="form-group">
              <label for="user_id">LRN/EMPLOYEE ID</label>
              <input type="text" class="form-control user_id" name="user_id" required />
            </div>
            <div class="form-group">
              <label for="fname">First Name</label>
          ...
          <div class="modal-footer justify-content-between">
            <button class="btn btn-danger" data-dismiss="modal">Close</button>
            <button name="edit-user" class="btn btn-primary" type="submit">
              Save
            </button>
          </div>
        </form>
 ...
 <?php
  ...
  <script>
    ...
    $(document).on("click", ".btn-edit", function() {
      ...
      let user_token = "_token-req89172310231";
      $.ajax({
        url: "../wp-includes/users.php",
        method: "POST",
        data: {
    ...
    $(document).on('click', '.btn-delete', function(e) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          setTimeout(function() {
            window.location.href = "../wp-includes/delete.php?delete_user=" + id;
          }, 1500);
        }
      });
    });
